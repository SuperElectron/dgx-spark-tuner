...
board figures: every `ctx_` prefix-caching cell and every `pp2048` cell below.
Scraping those six-plus figures is the cheapest standings gain available — the
numbers are already measured and sitting in the tables.
